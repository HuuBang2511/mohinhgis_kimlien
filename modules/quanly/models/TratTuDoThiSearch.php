...
/**
 * TratTuDoThiSearch represents the model behind the search form about `app\modules\quanly\models\TratTuDoThi`.
 */
class TratTuDoThiSearch extends TratTuDoThi
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['geom', 'dia_diem', 'thuc_trang', 'danh_gia', 'ghi_chu', 'to_dan_pho', 'can_bo', 'khu_vuc', 'lat', 'long', 'created_at', 'updated_at', 'file_dinhkem'], 'safe'],
    ...
    {
        $query = TratTuDoThi::find()->where(['status' => 1]);

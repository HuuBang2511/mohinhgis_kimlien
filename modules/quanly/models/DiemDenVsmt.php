...
/**
 * This is the model class for table "diem_den_vsmt".
 *
 * @property int $id
 ...
 */
class DiemDenVsmt extends QuanlyBaseModel
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['dia_chi', 'thuc_trang', 'de_nghi', 'danh_gia', 'to_dan_pho', 'can_bo', 'khu_vuc'], 'string', 'max' => 254],
        ];
    }

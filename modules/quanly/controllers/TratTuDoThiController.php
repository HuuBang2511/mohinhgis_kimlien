...
use app\modules\quanly\models\TratTuDoThiSearch;
...
/**
 * TratTuDoThiController implements the CRUD actions for TratTuDoThi model.
 */
class TratTuDoThiController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Trật tự đô thị";

    /**
     * Lists all TratTuDoThi models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TratTuDoThiSearch();
    ...
    /**
     * Displays a single TratTuDoThi model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TratTuDoThi model.
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/trat-tu-do-thi/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/trat-tu-do-thi/'.$model->id.'/';
    ...
    /**
     * Updates an existing TratTuDoThi model.
     * For ajax request will return json object
    ...
    /**
     * Finds the TratTuDoThi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TratTuDoThi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TratTuDoThi::findOne($id)) !== null) {
            return $model;
        } else {

...
use app\modules\quanly\models\TapKetRacSearch;
...
/**
 * TapKetRacController implements the CRUD actions for TapKetRac model.
 */
class TapKetRacController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Điểm tập kết rác";

    /**
     * Lists all TapKetRac models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TapKetRacSearch();
    ...
    /**
     * Displays a single TapKetRac model.
     * @param integer $id
     * @return mixed
     */
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/tap-ket-rac/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/tap-ket-rac/'.$model->id.'/';
    ...
    /**
     * Updates an existing TapKetRac model.
     * For ajax request will return json object
    ...
    /**
     * Finds the TapKetRac model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TapKetRac the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TapKetRac::findOne($id)) !== null) {
            return $model;
        } else {

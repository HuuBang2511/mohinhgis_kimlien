...
use app\modules\quanly\models\UnTacGiaoThongSearch;
...
/**
 * UnTacGiaoThongController implements the CRUD actions for UnTacGiaoThong model.
 */
class UnTacGiaoThongController extends \app\modules\quanly\base\QuanlyBaseController
{

    public $title = "Ùn tắc giao thông";

    /**
     * Lists all UnTacGiaoThong models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new UnTacGiaoThongSearch();
    ...
    /**
     * Displays a single UnTacGiaoThong model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new UnTacGiaoThong model.
        ...
        if($model->load($request->post()) && $model->save() && $filedinhkem->load($request->post())){
            ...
            if($filedinhkem->fileupload != null){
                ...
                foreach($filedinhkem->fileupload as $i => $item){
                    ...
                    $file[] = 'uploads/un-tac-giao-thong/'.$model->id.'/'.$item->baseName.'.'.$item->extension;
                    $path = 'uploads/un-tac-giao-thong/'.$model->id.'/';
    ...
    /**
     * Updates an existing UnTacGiaoThong model.
     * For ajax request will return json object
    ...
    /**
     * Finds the UnTacGiaoThong model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return UnTacGiaoThong the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = UnTacGiaoThong::findOne($id)) !== null) {
            return $model;
        } else {

...
/* @var $searchModel app\modules\quanly\models\UnTacGiaoThongSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Điểm ùn tắc giao thông';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="un-tac-giao-thong-index">
